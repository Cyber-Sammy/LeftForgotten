...
import static net.justmili.leftforgotten.core.util.DatagenAssetUtil.BlockModels.Families.*;
import static net.justmili.leftforgotten.core.util.DatagenAssetUtil.BlockModels.Individual.*;
import static net.justmili.leftforgotten.core.util.DatagenAssetUtil.ItemModels.createFlatItem;
...
public class LFModelProvider extends ImprovedModelProvider {
    ...
    public void generateBlockStateModels(BlockModelGenerators blockGen) {
        ...
        createChest(blockGen, LFBlocks.REMODEL_CHEST.get());
    }
