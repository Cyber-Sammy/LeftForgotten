...
public class DatagenAssetUtil {
    public static class BlockModels {
        ...
        public static class Individual {
             ...
             * Nature
             */
            public static void createFarmland(BlockModelGenerators blockGen, Block block) {
                TextureMapping dry = new TextureMapping()
                    .put(TextureSlot.DIRT, TextureMapping.getBlockTexture(LFBlocks.DIRT.get()))
                    .put(TextureSlot.TOP, TextureMapping.getBlockTexture(block));
                TextureMapping moist = new TextureMapping()
                    .put(TextureSlot.DIRT, TextureMapping.getBlockTexture(LFBlocks.DIRT.get()))
                    .put(TextureSlot.TOP, TextureMapping.getBlockTexture(block, "_moist"));
                ResourceLocation dryModel = ModelTemplates.FARMLAND.create(block, dry, blockGen.modelOutput);
                ResourceLocation moistModel = ModelTemplates.FARMLAND.create(
                    TextureMapping.getBlockTexture(block, "_moist"), moist, blockGen.modelOutput);
